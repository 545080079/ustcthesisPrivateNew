...
如图4.x，根据划分的微服务模型梳理的所有数据流转的对象主要有工作流、工作流模板、执行记录、执行器。由上述的对象构建一个系统的模型。
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{app-template-sx-1.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.1\textwidth]{start-execution-1.png}
\caption{开始执行}
\label{fig:kszx}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\textwidth]{3-2.jpg}
    \caption{普通执行器时序图}
    \label{fig:普通执行器时序图}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\textwidth]{3-3.jpg}
    \caption{并行执行器时序图}
    \label{fig:并行执行器时序图}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.2\textwidth]{cls-1.png}
    \caption{日志投递权限检查}
    \label{fig:rztdqx}
\end{figure}
